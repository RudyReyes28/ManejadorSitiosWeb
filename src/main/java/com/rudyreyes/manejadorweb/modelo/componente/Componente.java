...
public class Componente {
    ...
    public Componente(String idComponente, String idPagina, String claseComponente) {
        this.idComponente = idComponente;
        this.idPagina = idPagina;
        this.claseComponente = claseComponente;
    }

    public Componente(String idComponente, String idPagina, String claseComponente, List<Atributo> listaAtributos) {
        this.idComponente = idComponente;
        this.idPagina = idPagina;
        this.claseComponente = claseComponente;
